...
<body>
  ...
  <h1 class="site-heading text-center text-white d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3">Nomination Outputs</span>
    <span class="site-heading-lower">Parliamentary Election 2020</span>
  </h1>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav mx-auto">
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href='pe9.php'>PE09
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href='index.php'>PE10
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="index.php">PE11
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="index.php">PE30(1)(2)
              <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item active px-lg-4">
            <a class="nav-link text-uppercase text-expanded" href="index.php">PE09
              <span class="sr-only">(current)</span>
            </a>
          </li>
    ...
    <div class="container" id="example">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          ...
          <h2 class="section-heading mb-4">
            <span>PARLIAMENTARY ELECTIONS <br>පාර්ලිමේන්තු මැතිවරණය</span>
